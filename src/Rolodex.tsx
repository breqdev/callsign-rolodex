...
export default function Rolodex() {
  ...
  const { view, sort, filter, referenceType } = useContext(SettingsContext);
        ...
        <ViewComponent>
          {cards
            ...
            .map((card, i, arr) => {
              ...
              const tag = SORTS[Object.keys(SORTS)[sort ?? 0]].tag;
              if (tag && view === "column") {
            ...
            .filter((c) => {
              const method = SORTS[Object.keys(SORTS)[sort ?? 0]];
